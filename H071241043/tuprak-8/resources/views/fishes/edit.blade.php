...
@section('content')
<h2 class="text-center mb-4 text-white">Edit Fish: {{ $fish->name }}</h2>
                ...
                <div class="col-lg-7">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" min="0.01" max="100.00" class="form-control" id="catch_probability" name="catch_probability" 
                                   value="{{ old('catch_probability', $fish->catch_probability) }}" placeholder="e.g., 25.50" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="mb-3 h-100">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="10" 
                                  ...
                                  style="height: calc(100% - 38px); min-height: 150px;">{{ old('description', $fish->description) }}</textarea>
                    </div>
                </div>
            </div>
